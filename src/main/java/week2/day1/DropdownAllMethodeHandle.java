...
public class DropdownAllMethodeHandle {
	...
	public static void main(String[] args) {
		...
		WebElement marketCapaignEle = driver.findElement(By.id("createLeadForm_marketingCampaignId"));
		Select MarketCapaign = new Select(marketCapaignEle);
		MarketCapaign.selectByVisibleText("Automobile");
		...
		Select ownership = new Select (ownershipEle);
